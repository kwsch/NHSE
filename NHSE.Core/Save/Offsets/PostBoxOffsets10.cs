...
/// </summary>
public sealed class PostBoxOffsets10 : PostBoxOffsets
{
    // GSavePostBox
    ...
    public override int MailList => GSaveVersion + 0x108; // Beginning of mail list
    public override int FontTable => GSaveVersion + 0x46E60; // The forbidden alphabetti soup
    public override int LatestUniqueId => 0xb44578; // Next post index slot
}