...
public static class FileHashRevision
{
    ...
    public static readonly FileHashInfo REV_300 = new([
        new(FN_MAIN, REV_300_MAIN, [
            new(0x000110, 0x1e339c),
            new(0x1e34b0, 0x3d089c),
            new(0x5b3e60, 0x037acc),
            new(0x5eb930, 0x03ce5c),
            new(0x6288a0, 0x037acc),
            new(0x660370, 0x03ce5c),
            new(0x69d2e0, 0x037acc),
            new(0x6d4db0, 0x03ce5c),
            new(0x711d20, 0x037acc),
            new(0x7497f0, 0x03ce5c),
            new(0x786760, 0x037acc),
            new(0x7be230, 0x03ce5c),
            new(0x7fb1a0, 0x037acc),
            new(0x832c70, 0x03ce5c),
            new(0x86fbe0, 0x037acc),
            new(0x8a76b0, 0x03ce5c),
            new(0x8e4620, 0x037acc),
            new(0x91c0f0, 0x03ce5c),
            new(0x958f50, 0x057f3c),
        ]),
